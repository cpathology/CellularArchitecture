...
RUN pip install openslide-python==1.2.0 opencv-python==4.5.4.60 umap-learn==0.5.3 xgboost==1.5.1 
RUN pip install histocartography==0.2.1 scikit-image==0.18.0 mahotas==1.4.12 
